...
describe('FolderList', () => {
  ...
  it('renders list of folders', () => {
    render(<FolderList folders={foldersMock} onSelectAction={() => {}} selectedId={null} />)
    expect(screen.getByText('Folder 1')).toBeInTheDocument()
    expect(screen.getByText('Folder 2')).toBeInTheDocument()
  })

  it('applies selected style to selected folder', () => {
    render(<FolderList folders={foldersMock} onSelectAction={() => {}} selectedId="2" />)
  ...
  it('calls onSelectAction when a folder is clicked', () => {
    ...
    render(<FolderList folders={foldersMock} onSelectAction={onSelectActionMock} selectedId={null} />)
