            ...
            <table className="w-full text-sm text-white">
                ...
                {sortedProfiles.map((profile) => (
                    ...
                    >
                        ...
                        <td className="px-3 py-2">
                            <Badge
                                className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium border border-pink-600 text-pink-600">
                                {profile.status}
                            </Badge>
                        </td>
                        <td className="px-3 py-2">
                        ...
                        <td className="px-3 py-2 text-left">
                            {profile.note && (
                                <div
                                    className="inline-flex gap-2 border-l-4 border-yellow-500 bg-[#3a3f40] text-white px-3 py-1 text-xs">
                                    {profile.note}
                                </div>
                            )}
                        </td>
