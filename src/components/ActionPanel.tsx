                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <button onClick={onUploadAction} className="hover:text-green-400 transition" aria-label="Загрузить">
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <button onClick={onDownloadAction} className="hover:text-blue-400 transition" aria-label="Скачать">
