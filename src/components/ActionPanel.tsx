    ...
    return (
        ...
        <span className="font-bold text-sm text-zinc-400 border border-zinc-700 rounded-md px-2 py-0.5">
          {selectedCount}
            ...
            <div
                className="flex sticky z-1 rounded-3xl border-zinc-700 bg-[#1a1c23] px-6 py-3 justify-end items-center gap-10 text-white">
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <button onClick={onUpload} className="hover:text-green-400 transition"
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <button onClick={onDownload} className="hover:text-blue-400 transition"
                                    aria-label="Скачать">
